  ...
  return (
    <div className="traffic-chart">
      <svg viewBox={`0 0 ${width} ${height}`} role="img" aria-label="Daily click traffic chart">
        <defs><linearGradient id="analytics-fill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#55e6a8" stopOpacity=".28" /><stop offset="100%" stopColor="#55e6a8" stopOpacity="0" /></linearGradient></defs>
        ...
        {area && <polygon className="analytics-area" points={area} />}
